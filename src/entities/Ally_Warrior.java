...
public class Ally_Warrior extends GameObject{
	...
	private Image warrior_img0 = new ImageIcon("res/A_RUN_000.png").getImage();
	private Image warrior_img1 = new ImageIcon("res/A_RUN_001.png").getImage();
	private Image warrior_img2 = new ImageIcon("res/A_RUN_002.png").getImage();
	private Image warrior_img3 = new ImageIcon("res/A_RUN_003.png").getImage();
	private Image warrior_img4 = new ImageIcon("res/A_RUN_004.png").getImage();
	private Image warrior_img5 = new ImageIcon("res/A_RUN_005.png").getImage();
	private Image warrior_img6 = new ImageIcon("res/A_RUN_006.png").getImage();
	
	

	public Ally_Warrior(int x, int y, ID id, Handler handler, int sentX, int sentY) {
		super(x, y, id);
		...
		AudioPlayer.getSound("warrior_deploy").play(1.0f ,0.6f * AudioPlayer.sound_solume_multiplier);
